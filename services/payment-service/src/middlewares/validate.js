...
/**
 * Express middleware for validating incoming HTTP request data against a Zod schema.
 * Coerces and sanitizes body, query, and params and forwards formatted field-level errors.
 *
