 ...
 * Automatically executes BEGIN, COMMIT, ROLLBACK on error, and guarantees client release.
 *
 * @template T
 * @param {(client: import('pg').PoolClient) => Promise<T>} callback - Transactional operations.
